...
public class ReflectionMapperTest {
    ...
    public void testMapper1() {
        String simpleJson =
                "{\n" +
                        "  \"a\": \"a\",\n" +
                        "  \"b\": 2,\n" +
                        "  \"extras\": {\"R01\" : \"NIC\", \"X07\": \"+1 555 CALLME\", \"PRI\": -1}\n" +
                        "}";
    ...
    public void testBigPOJOMapping() throws Exception {
        ...
        assertEquals("currency set correctly", Currency.RUB, pi.getCurrency()); //todo question Currency.RUB
    ...
    @Test
    public void proxod() {
        String json = "{\"i\":5, \"myClass2\": {\"str\": \"valuesStr\", \"ii\": 55}}";
        JSONElement je = new ImplementedJsonParser().parse(new StringReader(json));
       /*Gson gson = new Gson();
        MyClass1 mc =  gson.fromJson(json, MyClass1.class);*/

        MyClass1 info = mapper.createObject(je, MyClass1.class);
    }
    ...
    public static class ProprietaryPOJO {
