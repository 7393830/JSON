...
public class JsonParserTest {
    ...
    public  void testReaderService() throws Exception {
        ...
        String str = "3.14";//"[1,]2";//"{\"a\":true true,}"; //"{\"kal\"}";//"{}[],:\"";//"{[/T6\\R\rG.?,\":}]";//"66";
        JSONElement je = sjp.parse(new StringReader(str));
        //ReaderService rs = new ReaderService(new StringReader(str));
        //rs.Separation();
        //JSONElement je = sjp.parse(new StringReader(str));
    ...
    @Test
    public  void testStringPrimitiveFromFile() throws Exception {
        BufferedReader rd = null;
        rd = new BufferedReader(new FileReader("C:\\Work\\input.txt"));
